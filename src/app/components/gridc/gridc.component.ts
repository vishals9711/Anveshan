...
@Component({
    templateUrl: './gridc.component.html',
    styles: [`
    button[disabled] {
      opacity: 0.5;
      cursor:  not-allowed;
...
export class gridciComponent implements OnInit {
    // Devices List
    errorMessage: string;
    devices;
    totalDevices: number;
            ...
            if (message["type"] === "new_sensorData") {
                ...
                if (payload.id === "1") {
                    ...
                    if (payload.type === "HRMVA") {
                        ...
                        //device["data"] = payload;
                        for (this.numb_var = 2; this.numb_var < 33; this.numb_var++) {
                            console.log("2222222222222222222222");
                            console.log(payload[this.numb_var]);
                            console.log("2222222222222222222222");
